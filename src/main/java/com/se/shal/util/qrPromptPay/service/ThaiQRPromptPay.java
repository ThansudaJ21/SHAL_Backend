package com.se.shal.util.qrPromptPay.service;
...
public class ThaiQRPromptPay {
    ...
    private ThaiQRPromptPay(Builder builder) {
        if (builder.selectPromptPayTypeBuilder.selectPromptPayType instanceof Builder.SelectPromptPayTypeBuilder.CreditTransferBuilder) {
            ...
            this.paymentField = Constants.BILL_PAYMENT_DATA_FIELD_ID;
            this.acquirerId = Constants.BILL_PAYMENT_DATA_ACQUIRER_ID;
    ...
    private String generateBOT() {
        ...
        stringBuilder.append("\n");
        if (amount != null) {
            stringBuilder.append(amount.multiply(Constants.oneHundred).setScale(0, RoundingMode.DOWN));
        } else {
    ...
    private String generatePromptPayQR() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append(generateField(0, Constants.PAYLOAD_FORMAT_INDICATOR));
        ...
        if (paymentField == 29) {
            if (mobileNumber != null) {
                ...
                content.append(generateField(1, "00" + Constants.DEFAULT_COUNTRY_CODE_TEL + mobileNumber));
    ...
    public static class Builder {
        ...
        protected String currencyCode = Constants.DEFAULT_CURRENCY_CODE;
        protected String countryCode = Constants.DEFAULT_COUNTRY_CODE;
        ...
        public Builder currencyCode(String currencyCode) {
            Helper.validateNumeric("Currency Code", currencyCode);
            Helper.validateLength("Currency Code", currencyCode, 3);
        ...
        public Builder countryCode(String countryCode) {
            Helper.validateLength("Country Code", countryCode, 2);
            this.countryCode = countryCode.toUpperCase();
            return this;
        }

        public SelectPromptPayTypeBuilder staticQR() {
            this.usageType = Constants.STATIC_QR_CODE;
            this.outputType = OutputType.PROMPTPAY;
            return selectPromptPayTypeBuilder;
        }

        public SelectPromptPayTypeBuilder dynamicQR() {
            this.usageType = Constants.DYNAMIC_QR_CODE;
            this.outputType = OutputType.PROMPTPAY;
            return selectPromptPayTypeBuilder;
        }
        ...
        public class SelectPromptPayTypeBuilder {
            ...
            private class CreditTransferBuilder implements SelectPromptPayType, CreditTransferBuilderIdentifier, CreditTransferBuilderAmount {
                ...
                public CreditTransferBuilderAmount mobileNumber(String mobileNumber) {
                    Helper.validateNumeric("Mobile Number", mobileNumber);
                    Helper.validateLength("Mobile Number", mobileNumber, 10);
                ...
                public CreditTransferBuilderAmount nationalId(String nationalId) {
                    Helper.validateNumeric("National ID/Tax ID", nationalId);
                    Helper.validateLength("National ID/Tax ID", nationalId, 13);
                ...
                public CreditTransferBuilderAmount eWalletId(String eWalletId) {
                    Helper.validateNumeric("E-Wallet ID", eWalletId);
                    Helper.validateLength("E-Wallet ID", eWalletId, 15);
                ...
                public BuildReady amount(BigDecimal amount) {
                    Helper.validateLength("Amount", MONEY_FORMAT.format(amount), 13);
                    Helper.validateAmount(amount);
            ...
            private class BillPaymentBuilder implements SelectPromptPayType, BillPaymentBuilderBillerId, BillPaymentBuilderRef1, BillPaymentBuilderOptionalDetail {
                ...
                public BillPaymentBuilderRef1 billerId(String billerId) {
                    Helper.validateNumeric("Biller ID", billerId);
                    Helper.validateLength("Biller ID", billerId, 15);
                ...
                public BillPaymentBuilderOptionalDetail ref1(String ref1) {
                    Helper.validateAlphanumeric("Reference 1", ref1);
                    Helper.validateLength("Reference 1", ref1, 15);
                    this.ref1 = ref1;
                    return this;
                }
                ...
                public BillPaymentBuilderOptionalDetail ref2(String ref2) {
                    Helper.validateAlphanumeric("Reference 2", ref2);
                    Helper.validateLength("Reference 2", ref2, 20);
                    this.ref2 = ref2;
                    return this;
                }
                ...
                public BillPaymentBuilderOptionalDetail ref3(String ref3) {
                    Helper.validateAlphanumeric("Reference 3", ref3);
                    Helper.validateLength("Terminal ID/Reference 3", ref3, 26);
                    this.ref3 = ref3;
                    return this;
                }
